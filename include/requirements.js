...
module.exports = function PB(config) {
    ...
    Object.defineProperty(pb, 'utils', {
        get: function() {
            pb.log.warn('Main: pb.utils is deprecated.  Use pb.util instead');
            return pb.util;
        }
    });
    ...
    Object.defineProperty(pb, 'users', {
        get: function() {
            pb.log.warn('Main: pb.users is deprecated.  Use new pb.UserService(context) instead');
    ...
    Object.defineProperty(pb, 'content', {
        get: function() {
            pb.log.warn('Main: pb.content is deprecated.  Use pb.ContentService instead');
    ...
    Object.defineProperty(pb, 'libraries', {
        get: function() {
            pb.log.warn('Main: pb.libraries is deprecated.  Use pb.LibrariesService instead');
            return new pb.ContentService();
        }
    });
    ...
    Object.defineProperty(pb, 'js', {
        get: function() {
            pb.log.warn('Main: pb.js is deprecated.  Use pb.ClientJs instead');
            return pb.ClientJS;
        }
    });						
    ...
    Object.defineProperty(pb, 'plugins', {
        get: function() {
            pb.log.warn('Main: pb.plugins is deprecated.  Use new pb.PluginService instead');
