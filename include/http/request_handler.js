...
module.exports = function RequestHandlerModule(pb) {
	 ...
	 * @type {Array}
	 */
	RequestHandler.CORE_ROUTES = require(path.join(pb.config.docRoot, '/plugins/pimpmycause/include/routes.js'))(pb);
	...
	RequestHandler.isValidRoute = function (descriptor) {
		return fs.existsSync(descriptor.controller) && !util.isNullOrUndefined(descriptor.path);
	};
